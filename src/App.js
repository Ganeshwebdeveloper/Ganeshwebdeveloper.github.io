...
function App() {
  ...
  var arr = [
    {
      img : "Booking.com3.jpg",title : "Clone of Booking.com",about : "Booking.com is a Dutch online travel agency for lodging reservations & other travel products.", techStack : ["html","css","javascript","Postman API"],netlifyLink:"https://frolicking-elf-dd1919.netlify.app/",gitLink:"https://github.com/gaurav7ingh/Booking.com"
    }, {
             ...
             <Stack w={"100%"} direction={{base:"column",sm:"column",md:"row",lg:"row"}} fontWeight="700" mt="80px" >
              ...
              <Text fontSize={["13px","lg"]} align="left" >HI, THIS IS</Text>
               ...
               <Link color='blue.500' h="40px" target={"_blank"} w="40%"  href="https://drive.google.com/file/d/1quHN3On1pOT_FTetIwSS-FcVrgkudJVx/view?usp=share_link" isExternal >
                ...
                <Image w="100%" src="https://raw.githubusercontent.com/Ganeshwebdeveloper/Ganeshwebdeveloper.github.io/main/public/PngItem_1.png" />
              </Box>
             </Stack>
